...
#[ApiResource(
    ...
    operations: [
        ...
        new GetCollection(),
        new Get(
            name: 'Liste_candidat_accepté',
            uriTemplate: '/candidatAccept',
            controller: FormationController::class . '::ListAcceptedCandidatures',
            description: 'Cet endpoint permet de recuperer les candidat acceptées ',
            read: false,
            deserialize: false
        ),
        new Get(
            name: 'Liste_candidat_refusé',
            uriTemplate: '/candidatRefuse',
            controller: FormationController::class . '::ListRefusedCandidatures',
            description: 'Cet endpoint permet de recuperer les candidat refusés',
            read: false,
            deserialize: false
        ),
    ]
