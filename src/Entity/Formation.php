...
#[ApiResource(
    ...
    operations: [
        ...
        new GetCollection(),
        new Get(
            name: 'Accepter_un_candidat',
            uriTemplate: '/candidat/{id}/accepte',
            controller: FormationController::class . '::AcceptCandidature',
            requirements: ['id' => '\d+'],
            description: 'Cet endpoint permet d\'accepter un candidat ',
            read: false,
            deserialize: false
        ),
        new Get(
            name: 'Refuser_un_candidat',
            uriTemplate: '/candidat/{id}/refuse',
            controller: FormationController::class . '::RefuseCandidature',
            requirements: ['id' => '\d+'],
            description: 'Cet endpoint permet de refuser un candidat',
            read: false,
            deserialize: false
        ),01111111
    ],
...
class Formation implements JsonSerializable
{
    ...
    #[ORM\OneToMany(mappedBy: 'formation', targetEntity: Candidat::class, orphanRemoval: true)]
    ...
    public function addCandidature(Candidat $candidature): static
    {
    ...
    public function removeCandidature(Candidat $candidature): static
    {
